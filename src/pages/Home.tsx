...
const Home: React.FC = () => {
  return (
    <main className="home container mx-auto p-4 text-gray-700 text-center">
      <h1 className="home__title text-3xl mb-4">Create Your Virtual Business Card</h1>
      <p className="home__text mb-7">Design professional business cards in minutes with our easy-to-use editor.</p>
